...
(function () {
  ...
  var T = {
    ...
    zh: {
      ...
      'help.qs_s2_desc': '安装 <a href="https://chromewebstore.google.com/detail/tweetclaw/nolgcgfoebklpejfgebinnakamjamkna" target="_blank">TweetClaw Chrome 扩展</a>，然后在 Chrome 中打开 <a href="https://x.com" target="_blank">x.com</a>——TweetClaw 会自动在 <code>20086</code> 端口启动本地 WebSocket 服务。',
      'help.qs_s3_title': '配置 AI 模型',
      'help.qs_s3_desc': '在 TweetPilot 中进入 <strong>设置 → AI 提供商</strong>，填入 OpenAI、Anthropic 或 DeepSeek 的 API 密钥。这是 AI 聊天和所有自动化操作的核心。',
      'help.qs_s4_title': '添加 Twitter 账号',
      'help.qs_s4_desc': '在侧边栏进入「账号」，点击「添加账号」，选择 TweetClaw（浏览器模式）——TweetPilot 会自动识别你已登录的 Twitter 会话。',
      'help.qs_s5_title': '运行第一个脚本',
      'help.qs_s5_desc': '创建一个工作空间，打开 AI 聊天，输入"搜索过去 24 小时关于 AI 自动化的推文"之类的指令，代理会用你连接的账号执行。',
